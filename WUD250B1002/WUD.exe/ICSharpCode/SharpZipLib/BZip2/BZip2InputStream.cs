namespace ICSharpCode.SharpZipLib.BZip2
{
    ...
    public class BZip2InputStream : Stream
    {
        ...
        private void GetAndMoveToFrontDecode()
        {
            ...
            if (((num10 - this.baseArray[num8][n]) < 0) || ((num10 - this.baseArray[num8][n]) >= 0x102))
            {
                throw new BZip2Exception("Bzip data error");
            }
        ...
        Label_0163:
            ...
            if ((num != 0) && (num != 1))
            {
                ...
                this.unzftab[this.seqToUnseq[num15]]++;
        ...
        Label_0178:
            ...
            switch (this.perm[num8][num10 - this.baseArray[num8][n]])
            {
                case 0:
                case 1:
                    goto Label_0178;
        ...
        private void RecvDecodingTables()
        {
            ...
            for (int num18 = 0; num18 < num7; num18++)
            {
                ...
                HbCreateDecodeTables(this.limit[num18], this.baseArray[num18], this.perm[num18], chArray[num18], num19, num20, alphaSize);
