    ...
    internal class DownloadManager
    {
        ...
        private void processQueue()
        {
            ...
            for (int i = 0; i < Program.DLManager.Queue.Count; i++)
            {
                ...
                this.CurrentDownload.filename = str2;
        ...
        private void ReadCallBack(IAsyncResult asyncResult)
        {
            ...
            else
            {
                ...
                try
                {
                    FileInfo info = new FileInfo(this.CurrentDownload.filename) {
                        LastWriteTime = this.CurrentDownload.lastModified
                    };
                }
                catch (Exception)
                {
        ...
        private void ResponseCallback(IAsyncResult asyncResult)
        {
            ...
            this.CurrentDownload.lastModified = this.Response.LastModified;
