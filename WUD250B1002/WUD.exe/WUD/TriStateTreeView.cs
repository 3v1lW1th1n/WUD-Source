namespace WUD
{
    ...
    public class TriStateTreeView : TreeView
    {
        ...
        private void _SetCheckedRecursive(TreeNodeCollection nodes, CheckState state)
        {
            if ((nodes != null) && (nodes.Count != 0))
            {
                foreach (TreeNode node in nodes)
                {
                    ...
                    this._SetCheckedRecursive(node.Nodes, state);
                }
            }
        }
        ...
        {
            this._SetCheckedRecursive(base.Nodes, CheckState.Checked);
        }
        ...
        {
            this._SetCheckedRecursive(base.Nodes, CheckState.Unchecked);
        }
