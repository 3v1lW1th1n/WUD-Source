namespace WUD.SimpleInterprocessCommunications
{
    ...
    public class EnumWindowsItem
    {
        ...
        public ExtendedWindowStyleFlags ExtendedWindowStyle =>
            ((ExtendedWindowStyleFlags) UnManagedMethods.GetWindowLong(this.hWnd, -20));
        ...
        {
            get => 
                (UnManagedMethods.IsIconic(this.hWnd) != 0);
            set
            {
        ...
        {
            get => 
                (UnManagedMethods.IsZoomed(this.hWnd) != 0);
            set
            {
        ...
        public bool Visible =>
            (UnManagedMethods.IsWindowVisible(this.hWnd) != 0);

        public WindowStyleFlags WindowStyle =>
            ((WindowStyleFlags) UnManagedMethods.GetWindowLong(this.hWnd, -16));
